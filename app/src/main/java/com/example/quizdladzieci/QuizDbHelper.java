...
public class QuizDbHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "QuizDlaDzieci3.db";
    ...
    private void fillQuestionsTable() {
        ...
        Question q361 = new Question(" 15 / 5 = ? ", "3 ", "5 ", "4 ", 1, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q361);
        Question q362 = new Question(" 16 / 8 = ? ", "3 ", "2 ", "1 ", 2, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q362);
        Question q363 = new Question(" 8 / 4 = ? ", "4 ", "3 ", "2 ", 3, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q363);
        Question q364 = new Question(" 16 / 4 = ? ", "4 ", "7 ", "2 ", 1, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q364);
        Question q365 = new Question(" 16 / 4 = ? ", "6 ", "4 ", "3 ", 2, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q365);
        Question q366 = new Question(" 18 / 2 = ? ", "6 ", "12 ", "9 ", 3, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q366);
        Question q367 = new Question(" 12 / 4 = ? ", "3 ", "4 ", "2 ", 1, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q367);
        Question q368 = new Question(" 15 / 3 = ? ", "7 ", "5 ", "4 ", 2, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q368);
        Question q369 = new Question(" 18 / 6 = ? ", "4 ", "5 ", "3 ", 3, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q369);
        Question q370 = new Question(" 10 / 2 = ? ", "5 ", "6 ", "2 ", 1, Question.DIFFICULTY_EASY,Sets.I, Category.DZIELENIE);
        addQuestion(q370);

        //zestawI_dzielenie_medium q380
        Question q371 = new Question(" 68 / 4 = ? ", "17 ", "18 ", "15 ", 1, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q371);
        Question q372 = new Question(" 42 / 7 = ? ", "7 ", "6 ", "4 ", 2, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q372);
        Question q373 = new Question(" 42 / 14 = ? ", "2 ", "5 ", "3 ", 3, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q373);
        Question q374 = new Question(" 51 / 17 = ? ", "3 ", "5 ", "2 ", 1, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q374);
        Question q375 = new Question(" 28 / 7 = ? ", "6 ", "4 ", "3 ", 2, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q375);
        Question q376 = new Question(" 24 / 8 = ? ", "2 ", "4 ", "3 ", 3, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q376);
        Question q377 = new Question(" 75 / 5 = ? ", "15 ", "17 ", "14 ", 1, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q377);
        Question q378 = new Question(" 51 / 3 = ? ", "18 ", "17 ", "16 ", 2, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q378);
        Question q379 = new Question(" 64 / 16 = ? ", "2 ", "5 ", "4 ", 3, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q379);
        Question q380 = new Question(" 78 / 13 = ? ", "6 ", "8 ", "5 ", 1, Question.DIFFICULTY_MEDIUM,Sets.I, Category.DZIELENIE);
        addQuestion(q380);

        //zestawI_dzielenie_hard q390
        Question q381 = new Question(" 445 / 5 = ? ", "89 ", "90 ", "86 ", 1, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q381);
        Question q382 = new Question(" 546 / 78 = ? ", "8 ", "7 ", "4 ", 2, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q382);
        Question q383 = new Question(" 351 / 9 = ? ", "37 ", "41 ", "39 ", 3, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q383);
        Question q384 = new Question(" 476 / 119 = ? ", "4 ", "8 ", "6 ", 1, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q384);
        Question q385 = new Question(" 222 / 6 = ? ", "38 ", "37 ", "36 ", 2, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q385);
        Question q386 = new Question(" 280 / 7 = ? ", "39 ", "41 ", "40 ", 3, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q386);
        Question q387 = new Question(" 453 / 151 = ? ", "3 ", "5 ", "4 ", 1, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q387);
        Question q388 = new Question(" 456 / 76 = ? ", "5 ", "6 ", "4 ", 2, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q388);
        Question q389 = new Question(" 504 / 72 = ? ", "5 ", "8 ", "7 ", 3, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q389);
        Question q390 = new Question(" 826 / 118 = ? ", "7 ", "8 ", "6 ", 1, Question.DIFFICULTY_HARD,Sets.I, Category.DZIELENIE);
        addQuestion(q390);

        //zestawII_dzielenie_easy q400
        Question q391 = new Question(" 14 / 7 = ? ", "2 ", "5 ", "3 ", 1, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q391);
        Question q392 = new Question(" 20 / 5 = ? ", "6 ", "4 ", "2 ", 2, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q392);
        Question q393 = new Question(" 6 / 3 = ? ", "3 ", "5 ", "2 ", 3, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q393);
        Question q394 = new Question(" 16 / 4 = ? ", "4 ", "5 ", "3 ", 1, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q394);
        Question q395 = new Question(" 12 / 6 = ? ", "3 ", "2 ", "1 ", 2, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q395);
        Question q396 = new Question(" 18 / 9 = ? ", "4 ", "3 ", "2 ", 3, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q396);
        Question q397 = new Question(" 18 / 3 = ? ", "6 ", "8 ", "5 ", 1, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q397);
        Question q398 = new Question(" 8 / 2 = ? ", "5 ", "4 ", "3 ", 2, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q398);
        Question q399 = new Question(" 15 / 3 = ? ", "3 ", "6 ", "5 ", 3, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q399);
        Question q400 = new Question(" 8 / 4 = ? ", "2 ", "4 ", "3 ", 1, Question.DIFFICULTY_EASY,Sets.II, Category.DZIELENIE);
        addQuestion(q400);

        //zestawII_dzielenie_medium q410
        Question q401 = new Question(" 54 / 6 = ? ", "9 ", "11 ", "8 ", 1, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q401);
        Question q402 = new Question(" 50 / 5 = ? ", "12 ", "10 ", "8 ", 2, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q402);
        Question q403 = new Question(" 100 / 10 = ? ", "8 ", "13 ", "10 ", 3, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q403);
        Question q404 = new Question(" 40 / 8 = ? ", "5 ", "8 ", "4 ", 1, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q404);
        Question q405 = new Question(" 93 / 3 = ? ", "34 ", "31 ", "29 ", 2, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q405);
        Question q406 = new Question(" 52 / 26 = ? ", "3 ", "5 ", "2 ", 3, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q406);
        Question q407 = new Question(" 65 / 5 = ? ", "13 ", "16 ", "12 ", 1, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q407);
        Question q408 = new Question(" 84 / 42 = ? ", "4 ", "2 ", "1 ", 2, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q408);
        Question q409 = new Question(" 66 / 6 = ? ", "9 ", "13 ", "11 ", 3, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q409);
        Question q410 = new Question(" 28 / 4 = ? ", "7 ", "10 ", "6 ", 1, Question.DIFFICULTY_MEDIUM,Sets.II, Category.DZIELENIE);
        addQuestion(q410);

        //zestawII_dzielenie_hard q420
        Question q411 = new Question(" 954 / 106 = ? ", "9 ", "10 ", "7 ", 1, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q411);
        Question q412 = new Question(" 720 / 36 = ? ", "22 ", "20 ", "17 ", 2, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q412);
        Question q413 = new Question(" 649 / 11 = ? ", "58 ", "64 ", "59 ", 3, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q413);
        Question q414 = new Question(" 660 / 11 = ? ", "60 ", "61 ", "59 ", 1, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q414);
        Question q415 = new Question(" 860 / 172 = ? ", "6 ", "5 ", "7 ", 2, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q415);
        Question q416 = new Question(" 240 / 80 = ? ", "3 ", "4 ", "5 ", 3, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q416);
        Question q417 = new Question(" 360 / 6 = ? ", "60 ", "61 ", "58 ", 1, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q417);
        Question q418 = new Question(" 681 / 227 = ? ", "4 ", "3 ", "5 ", 2, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q418);
        Question q419 = new Question(" 552 / 69 = ? ", "7 ", "5 ", "8 ", 3, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q419);
        Question q420 = new Question(" 840 / 24 = ? ", "35 ", "39 ", "33 ", 1, Question.DIFFICULTY_HARD,Sets.II, Category.DZIELENIE);
        addQuestion(q420);

        //zestawIII_dzielenie_easy q430
        Question q421 = new Question(" 14 / 2 = ? ", "7 ", "8 ", "5 ", 1, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q421);
        Question q422 = new Question(" 10 / 2 = ? ", "6 ", "5 ", "4 ", 2, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q422);
        Question q423 = new Question(" 16 / 8 = ? ", "3 ", "5 ", "2 ", 3, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q423);
        Question q424 = new Question(" 12 / 2 = ? ", "6 ", "7 ", "4 ", 1, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q424);
        Question q425 = new Question(" 10 / 2 = ? ", "6 ", "5 ", "4 ", 2, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q425);
        Question q426 = new Question(" 18 / 2 = ? ", "7 ", "10 ", "9 ", 3, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q426);
        Question q427 = new Question(" 20 / 2 = ? ", "10 ", "13 ", "8 ", 1, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q427);
        Question q428 = new Question(" 18 / 2 = ? ", "10 ", "9 ", "8 ", 2, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q428);
        Question q429 = new Question(" 6 / 2 = ? ", "2 ", "4 ", "3 ", 3, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q429);
        Question q430 = new Question(" 8 / 2 = ? ", "4 ", "5 ", "2 ", 1, Question.DIFFICULTY_EASY,Sets.III, Category.DZIELENIE);
        addQuestion(q430);

        //zestawIII_dzielenie_medium q440
        Question q431 = new Question(" 36 / 12 = ? ", "3 ", "6 ", "2 ", 1, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q431);
        Question q432 = new Question(" 62 / 31 = ? ", "3 ", "2 ", "4 ", 2, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q432);
        Question q433 = new Question(" 57 / 19 = ? ", "2 ", "6 ", "3 ", 3, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q433);
        Question q434 = new Question(" 60 / 12 = ? ", "5 ", "8 ", "3 ", 1, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q434);
        Question q435 = new Question(" 81 / 27 = ? ", "4 ", "3 ", "1 ", 2, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q435);
        Question q436 = new Question(" 100 / 20 = ? ", "2 ", "3 ", "5 ", 3, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q436);
        Question q437 = new Question(" 96 / 4 = ? ", "24 ", "25 ", "22 ", 1, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q437);
        Question q438 = new Question(" 22 / 11 = ? ", "3 ", "2 ", "1 ", 2, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q438);
        Question q439 = new Question(" 52 / 4 = ? ", "11 ", "16 ", "13 ", 3, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q439);
        Question q440 = new Question(" 78 / 6 = ? ", "13 ", "15 ", "11 ", 1, Question.DIFFICULTY_MEDIUM,Sets.III, Category.DZIELENIE);
        addQuestion(q440);

        //zestawIII_dzielenie_hard q450
        Question q441 = new Question(" 576 / 36 = ? ", "16 ", "18 ", "15 ", 1, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q441);
        Question q442 = new Question(" 450 / 6 = ? ", "78 ", "75 ", "69 ", 2, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q442);
        Question q443 = new Question(" 954 / 18 = ? ", "51 ", "56 ", "53 ", 3, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q443);
        Question q444 = new Question(" 744 / 31 = ? ", "24 ", "29 ", "23 ", 1, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q444);
        Question q445 = new Question(" 318 / 159 = ? ", "4 ", "2 ", "3 ", 2, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q445);
        Question q446 = new Question(" 630 / 315 = ? ", "3 ", "4 ", "2 ", 3, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q446);
        Question q447 = new Question(" 400 / 5 = ? ", "80 ", "83 ", "76 ", 1, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q447);
        Question q448 = new Question(" 759 / 33 = ? ", "20 ", "23 ", "18 ", 2, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q448);
        Question q449 = new Question(" 274 / 137 = ? ", "3 ", "4 ", "2 ", 3, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q449);
        Question q450 = new Question(" 221 / 13 = ? ", "17 ", "23 ", "11 ", 1, Question.DIFFICULTY_HARD,Sets.III, Category.DZIELENIE);
        addQuestion(q450);

        //zestawIV_dzielenie_easy q460
        Question q451 = new Question(" 18 / 9 = ? ", "2 ", "3 ", "4 ", 1, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q451);
        Question q452 = new Question(" 12 / 2 = ? ", "8 ", "6 ", "4 ", 2, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q452);
        Question q453 = new Question(" 20 / 5 = ? ", "3 ", "6 ", "4 ", 3, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q453);
        Question q454 = new Question(" 10 / 2 = ? ", "5 ", "6 ", "3 ", 1, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q454);
        Question q455 = new Question(" 14 / 2 = ? ", "8 ", "7 ", "5 ", 2, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q455);
        Question q456 = new Question(" 12 / 6 = ? ", "3 ", "4 ", "2 ", 3, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q456);
        Question q457 = new Question(" 18 / 9 = ? ", "2 ", "3 ", "4 ", 1, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q457);
        Question q458 = new Question(" 16 / 4 = ? ", "5 ", "4 ", "3 ", 2, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q458);
        Question q459 = new Question(" 16 / 8 = ? ", "3 ", "4 ", "2 ", 3, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q459);
        Question q460 = new Question(" 20 / 2 = ? ", "10 ", "12 ", "9 ", 1, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q460);

        //zestawIV_dzielenie_medium q470
        Question q461 = new Question(" 66 / 22 = ? ", "3 ", "6 ", "2 ", 1, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q461);
        Question q462 = new Question(" 48 / 3 = ? ", "17 ", "16 ", "14 ", 2, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q462);
        Question q463 = new Question(" 36 / 12 = ? ", "2 ", "4 ", "3 ", 3, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q463);
        Question q464 = new Question(" 84 / 21 = ? ", "4 ", "6 ", "2 ", 1, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q464);
        Question q465 = new Question(" 78 / 13 = ? ", "7 ", "6 ", "5 ", 2, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q465);
        Question q466 = new Question(" 78 / 3 = ? ", "25 ", "27 ", "26 ", 3, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q466);
        Question q467 = new Question(" 90 / 18 = ? ", "5 ", "8 ", "4 ", 1, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q467);
        Question q468 = new Question(" 70 / 5 = ? ", "15 ", "14 ", "13 ", 2, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q468);
        Question q469 = new Question(" 81 / 3 = ? ", "26 ", "30 ", "27 ", 3, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q469);
        Question q470 = new Question(" 39 / 13 = ? ", "3 ", "5 ", "2 ", 1, Question.DIFFICULTY_MEDIUM,Sets.IV, Category.DZIELENIE);
        addQuestion(q470);

        //zestawIV_dzielenie_hard q480
        Question q471 = new Question(" 555 / 185 = ? ", "3 ", "5 ", "4 ", 1, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q471);
        Question q472 = new Question(" 663 / 17 = ? ", "42 ", "39 ", "33 ", 2, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q472);
        Question q473 = new Question(" 915 / 15 = ? ", "59 ", "65 ", "61 ", 3, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q473);
        Question q474 = new Question(" 450 / 225 = ? ", "2 ", "3 ", "4 ", 1, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q474);
        Question q475 = new Question(" 713 / 31 = ? ", "26 ", "23 ", "18 ", 2, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q475);
        Question q476 = new Question(" 560 / 16 = ? ", "34 ", "36 ", "35 ", 3, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q476);
        Question q477 = new Question(" 728 / 14 = ? ", "52 ", "58 ", "47 ", 1, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q477);
        Question q478 = new Question(" 188 / 47 = ? ", "5 ", "4 ", "3 ", 2, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q478);
        Question q479 = new Question(" 495 / 99 = ? ", "4 ", "7 ", "5 ", 3, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q479);
        Question q480 = new Question(" 600 / 120 = ? ", "5 ", "4 ", "3 ", 1, Question.DIFFICULTY_HARD,Sets.IV, Category.DZIELENIE);
        addQuestion(q480);
